...
namespace AppEstacionamento.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            if(placa != null && placa.Length > 0 && !veiculos.Any(x => x.ToUpper() == placa.ToUpper())) veiculos.Add(placa.ToUpper());
            else Console.WriteLine("Erro ao adicionar! Tente novamente");
        }
        ...
        public void RemoverVeiculo()
        {
            ...
            // *IMPLEMENTE AQUI*
            string? placa = Console.ReadLine();
            if (placa == null || placa.Length <= 0) return;
            ...
            if (veiculos.Any(x => x.ToUpper() == placa))
            {
                ...
                decimal valorTotal = (horas * _precoPorHora) + _precoInicial;
